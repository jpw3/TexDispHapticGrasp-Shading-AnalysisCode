...
#3. Plot the AVERAGE GA for 15, 10 and 5 mm from the object as well as starting and flight time 
...
agg_data <- subject_data %>%
  ...
  summarize(average_5GA = mean(fiveGA, na.rm = TRUE), std_5GA = sd(fiveGA, na.rm = TRUE), stderr_5GA = computeBSSEM(fiveGA), average_10GA = mean(tenGA, na.rm = TRUE), stderr_10GA = computeBSSEM(tenGA), average_15GA = mean(fifteenGA, na.rm = TRUE), std_15GA = sd(fifteenGA, na.rm = TRUE), stderr_15GA = computeBSSEM(fifteenGA), average_starttime = mean(starttime, na.rm = TRUE), stderr_starttime = computeBSSEM(starttime), average_flighttime = mean(flighttime, na.rm = TRUE), stderr_starttime = computeBSSEM(flighttime)) ; #
...
agg <- agg_data %>%
  ...
  summarize(fiveGA = mean(average_5GA, na.rm = TRUE), stderr_5GA = computeBSSEM(average_5GA),
            ...
            st_time = mean(average_starttime, na.rm = TRUE), stderr_st_time = computeBSSEM(average_starttime), fl_time = mean(average_flighttime, na.rm = TRUE), stderr_fl_time = computeBSSEM(average_flighttime))
